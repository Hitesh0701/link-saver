...
export class UtilityService {
  ...
  validateCorporateEmail(controls) {
    ...
    const gmailRegEx = new RegExp(
      "[A-Z0-9a-z._%+-]+@[(?-i)gmail]+\\.[A-Za-z]{2,64}"
    );
    const yahoo = new RegExp(
      "[A-Z0-9a-z._%+-]+@[(?-i)yahoo]+\\.[A-Za-z]{2,64}"
    );
    const rediffmail = new RegExp(
      "[A-Z0-9a-z._%+-]+@[(?-i)rediffmail]+\\.[A-Za-z]{2,64}"
    );
    const yopmail = new RegExp(
      "[A-Z0-9a-z._%+-]+@[(?-i)yopmail]+\\.[A-Za-z]{2,64}"
    );
    const outlook = new RegExp(
      "[A-Z0-9a-z._%+-]+@[(?-i)outlook]+\\.[A-Za-z]{2,64}"
    );
    const hotmail = new RegExp(
      "[A-Z0-9a-z._%+-]+@[(?-i)hotmail]+\\.[A-Za-z]{2,64}"
    );
  ...
  toastSuccess(title, details) {
    this._toastr.success(details, title, {
      closeButton: true,
  ...
  toastInfo(title, details) {
    this._toastr.info(details, title, {
      closeButton: true,
      positionClass: "toast-top-center",
      timeOut: 1500
    });
  ...
  toastError(title, details) {
    this._toastr.error(details, title, {
      closeButton: true,
      positionClass: "toast-top-center",
      timeOut: 4000
    });
